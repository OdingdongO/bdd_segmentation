...
def dilate_resnet50(num_classes=2):
...
def dilate_resnet101(num_classes=2):
...
class seg_dilate_resnet50(nn.Module):
    def __init__(self, num_classes=2):
        super(seg_dilate_resnet50, self).__init__()
        d_resnet50 =dilate_resnet50(num_classes)
        self.resnet =nn.Sequential(*list(d_resnet50.children())[:-2])
        self.final = nn.Conv2d(int(32*alpha*alpha_up), num_classes, 1)
