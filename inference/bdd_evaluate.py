...
def parse_args():
    ...
    parser.add_argument('--task',default="drivable", help="'seg', 'det', 'drivable'")
    parser.add_argument('--gt',type=str,  default="/media/hszc/model/detao/data/bdd/bdd_testB/testB100",help='path to ground truth')
    parser.add_argument('--result',type=str, default="/media/hszc/model/detao/data/bdd/bdd_testB/testB_result_100", help='path to results to be evaluated')
